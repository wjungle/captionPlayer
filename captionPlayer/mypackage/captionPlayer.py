...
class Toolbar():
    ...
    def __init__(self, frameToolbar):
        ...
        self.cbb.grid(row=0, column=4, padx=2, pady=2)
        self.cbb.set("page")
        self.btnGPlay.grid(row=0, column=5, padx=2, pady=2)
        
        self.lbl0.grid(row=0, column=6, padx=2, pady=2)
        self.btnSpdUp.grid(row=0, column=7, padx=2, pady=2)
        self.lblSpd.grid(row=0, column=8, padx=2, pady=2)
        self.btnSpdDn.grid(row=0, column=9, padx=2, pady=2)
        self.btnEng.grid(row=0, column=10, padx=2, pady=2)
        self.btnCht.grid(row=0, column=11, padx=2, pady=2)
